...
void forward(const double* q, double* T)
{
  ...
  *T = ((c1 * c234 - s1 * s234) * s5) / 2.0 - c5 * s1
  ...
  *T =
  ...
  T++;
  *T = c1 * c5 + ((s1 * c234 + c1 * s234) * s5) / 2.0
...
void forward_all(
  const double* q, double* T1, double* T2, double* T3, double* T4, double* T5,
  double* T6)
{
  double s1 = sin(*q), c1 = cos(*q);
  q++;  // q1
  ...
  if(T6 != NULL)
  {
    ...
    *T6 = c5 * s1 - c234 * c1 * s5;
    T6++;
    *T6 = d6 * (c5 * s1 - c234 * c1 * s5) + c1 * (a3 * c23 + a2 * c2) + d4 * s1
      + d5 * s234 * c1;
    T6++;
    ...
    *T6 = -c1 * c5 - c234 * s1 * s5;
    T6++;
    *T6 = s1 * (a3 * c23 + a2 * c2) - d4 * c1 - d6 * (c1 * c5 + c234 * s1 * s5)
      + d5 * s234 * s1;
    T6++;
...
//        q_sols[i*6+0], q_sols[i*6+1], q_sols[i*6+2], q_sols[i*6+3],
//        q_sols[i*6+4], q_sols[i*6+5]);
//   for(int i=0;i<=4;i++)
//     printf("%f ", PI/2.0*i);
//   printf("\n");
//   return 0;
